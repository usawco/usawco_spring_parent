...
<script language="Javascript">
	...
	function selectReportedVersion(val) {
		var targetVersionDropdown = document.getElementById('targetVersion');
		var len = targetVersionDropdown.options.length;
		for (var i = 0; i < len; i++) {
			if (targetVersionDropdown.options[i].value == val) {
				targetVersionDropdown.selectedIndex = i;
				break;
			}
		}
	}
    ...
    <table width="100%">
		...
		<div id="upload" style="display:none"></div>
		 ...
		 <tr>
		   <td colspan="2">
				<ul>
					<li><a href="advanced-home.dsp">Generate Fix for another iTrac</a></li>
				</ul>
			</td>
		</tr>
		<tr>
				...
				<tr>
					...
					<td>	
						<table class="tableView" width="100%">
							...
							<tr>
								<td class="evenrow">iTrac Summary<b><font color="red">*</font></b></td>	
								<td class="evenrow-l">
							...
							<tr>
								<td class="oddrow">Reported Version</td>	
								<td class="oddrow-l">
									<input name="reportedVersions" id="reportedVersions" type="text" value="%value reportedVersions%" size="100" readonly>
								</td>
							</tr>
							...
							<tr>
								...
								<td class="evenrow-l">
									...
									%ifvar reportedVersion%
										<script>selectReportedVersion('%value reportedVersion%');</script>
									%endif%
								</td>
							</tr>
							<tr>
								<td class="oddrow">Required Core Fix Number</td>	
								<td class="oddrow-l">
							...
							<tr>
								<td class="evenrow">Fix Type<b><font color="red">*</font></b></td>	
								<td class="evenrow-l">
							...
							<tr>
								<td class="oddrow" id="fixVersionText" name="fixVersionText">Test Patch Version</td>	
								<td class="oddrow-l">
							...
							<tr>
								<td class="evenrow">Void Fix List</td>	
								<td class="evenrow-l">
							...
							<tr>
								<td class="oddrow">Package Zips</td>	
								<td class="oddrow-l">
							...
							<tr>
								<td class="oddrow">&nbsp;</td>	
								<td class="oddrow-l">
									For package fix, upload the partial package archive.
									<br>In Local IS(in which you have package related changes) Go to <br><b>Packages > Management > [PackageName] > Archive</b> to create partial package archive.<br>OR Use <a href="https://iwiki.eur.ad.sag/display/RNDWMIC/IS+Package+Archiver" target="_blank">IS Package Archiver</a>
								</td>
							</tr>
							<tr>
								<td class="evenrow">Readme File<b><font color="red">*</font></b></td>	
								<td class="evenrow-l">
