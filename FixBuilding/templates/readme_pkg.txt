...
This test patch can work with base {TARGET_VERSION} release or with any 
previously released official fix.
...
{ITRAC_ID} : IS not responding JSON content while responding to JSON request
...
2.	Put {FIX_JAR} into 
	<webMethods_directory>/IntegrationServer/instances/<is_instance>/replicate/inbound directory.
...
1. Using Admin UI -> Packages > Management > Recover Packages and select {TARGET_PACKAGE} as the package to be recovered
...
Copyright © 2014 Software AG, Darmstadt, Germany and/or Software 
